...
class Settings(BaseSettings):
    ...
    # QuickSetupProjectInput.expected_end_date u nového projektu při vystavení proformy (ES 2027)
    allfred_project_expected_end_date: str = "2027-02-10"
